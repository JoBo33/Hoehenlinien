...
namespace ContourMap
{
    class Calculation
    {
        ...
        public static List<Vector[]> DelaunayTriangulation(List<double[]> data, PlotModel model)
        {
        ...
        {
            double distance = Math.Sqrt(Math.Pow(currentPoint.X - centre.X, 2) + Math.Pow(currentPoint.Y - centre.Y, 2));
